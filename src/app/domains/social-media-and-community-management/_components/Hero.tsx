    ...
    <section className="relative min-h-[90vh] flex flex-col items-center justify-center pt-20 px-6 overflow-hidden bg-background">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
        ...
        <motion.div
           ...
           className="absolute top-1/4 right-[10%] w-64 h-40 bg-card border border-white/5 rounded-2xl p-4 rotate-12"
        >
         ...
         <motion.div
           ...
           className="absolute bottom-1/3 left-[5%] w-48 h-48 bg-card border border-white/5 rounded-full flex items-center justify-center -rotate-6"
        >
        ...
        <svg className="absolute inset-0 w-full h-full opacity-20">
            <line x1="80%" y1="30%" x2="60%" y2="50%" stroke="currentColor" strokeWidth="1" strokeDasharray="4 4" />
             <line x1="20%" y1="60%" x2="40%" y2="50%" stroke="currentColor" strokeWidth="1" strokeDasharray="4 4" />
        </svg>

         <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-accent/5 rounded-full blur-[100px] animate-pulse" />
      </div>
